...
const Resultados: React.FC<ScreenProps> = ({ onNavigate }) => {
    const [isModalVisible, setModalVisible] = useState(false);
    const images = [
        {
            url: '',
            props: {
                source: require("./images/resultadosoficial.jpg"),
            },
        },
    ];
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity onPress={toggleModal} style={styles.container} >
                <Image
                    source={require("./images/resultadosjpg.jpg")}
...
const styles = StyleSheet.create({
    ...
    results: {
        marginTop: 20,
        width: width > 800 ? wp('60%') : wp('80%'),
        height: height > 800 ? hp('60%') : hp('60%'),
        resizeMode: "contain",
